...
[DFeRoot("EnviarLoteDpsSincronoResposta", Namespace = "http://www.sped.fazenda.gov.br/nfse")]
public sealed class EnviarLoteDpsSincronoResposta : DFeDocument<EnviarLoteDpsSincronoResposta>
{
    /// <summary>
