...
[DFeRoot("ConsultarNfseServicoPrestadoResposta", Namespace = "http://www.sped.fazenda.gov.br/nfse")]
public sealed class ConsultarNfseServicoPrestadoResposta : DFeDocument<ConsultarNfseServicoPrestadoResposta>
{
    /// <summary>
