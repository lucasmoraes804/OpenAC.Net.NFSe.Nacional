...
[DFeRoot("ConsultarNfseFaixaResposta", Namespace = "http://www.sped.fazenda.gov.br/nfse")]
public sealed class ConsultarNfseFaixaResposta : DFeDocument<ConsultarNfseFaixaResposta>
{
    /// <summary>
